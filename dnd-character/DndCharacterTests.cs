...
namespace Exercism.CSharp.Solutions.DndCharacterExercise.Tests
{
    public class DndCharacterTests
    {
        ...
        public void Random_ability_is_distributed_correctly()
        {
            ...
            static int min(int expected) => (int)(expected * (times * 0.8));
            static int max(int expected) => (int)(expected * (times * 1.2));
