...
namespace Exercism.CSharp.Solutions.TournamentExercise.Tests
{
    public class TournamentTests
    {
        ...
        {
            const string rows = "";
            const string expected = "Team                           | MP |  W |  D |  L |  P";
        ...
        {
            const string rows = "Allegoric Alaskans;Blithering Badgers;win";
        ...
        {
            const string rows = "Blithering Badgers;Allegoric Alaskans;loss";
            const string expected =
                "Team                           | MP |  W |  D |  L |  P\n" +
                "Allegoric Alaskans             |  1 |  1 |  0 |  0 |  3\n" +
                "Blithering Badgers             |  1 |  0 |  0 |  1 |  0";
        ...
        {
            const string rows = "Blithering Badgers;Allegoric Alaskans;win";
            const string expected =
                "Team                           | MP |  W |  D |  L |  P\n" +
        ...
        {
            const string rows = "Allegoric Alaskans;Blithering Badgers;draw";
            const string expected =
                "Team                           | MP |  W |  D |  L |  P\n" +
