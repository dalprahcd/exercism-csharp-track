...
namespace Exercism.CSharp.Solutions.ResistorColorTrioExercise.Tests
{
    public class ResistorColorTrioTests
    {
        ...
        public void Should_ThrowException_NotEnoughColors()
        {
            ...
            ResistorColorTrio.Label(new[] { "black", "blue" }));
        }
        ...
        {
            Assert.Throws<ArgumentOutOfRangeException>(() =>
            ResistorColorTrio.Label(new[] { "cyan" }));
        }
