...
namespace Exercism.CSharp.Solutions.SimpleLinkedListExercise.Tests
{
    public class SimpleLinkedListTests
    {
        ...
        [Fact]
        public void Three_item_list_third_value()
        {
            var list = new SimpleLinkedList<int>(3).Add(2).Add(1);
            Assert.Equal(1, list.Next.Next.Value);
        }

        [Fact]
        public void Three_item_list_third_item_has_no_next()
        {
            var list = new SimpleLinkedList<int>(3).Add(2).Add(1);
        ...
        [Fact]
        public void Five_item_list_fifth_value()
        {
            var list = new SimpleLinkedList<int>(5).Add(4).Add(3).Add(2).Add(1);
            Assert.Equal(1, list.Next.Next.Next.Next.Value);
        }

        [Fact]
        public void Five_item_list_fifth_item_has_no_next()
        {
            var list = new SimpleLinkedList<int>(5).Add(4).Add(3).Add(2).Add(1);
